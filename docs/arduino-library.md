...
- Do not use `localhost` from a real board. From ESP32/ESP8266, `localhost` means the board itself; use your VPS IP or MQTT domain, such as `mqtt.rectronx.com` for the current test server.
